...
public class CircleColorViewAdapter extends BaseAdapter implements Filterable, ThemedSpinnerAdapter {
     ...
     */
    public CircleColorViewAdapter(Context context, List<? extends Map<String, ?>> data,
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (v != null) {
                ...
                if (!bound) {
                    ...
                    } else if (v instanceof CircleColorView){
                        ((CircleColorView) v).setColor((Integer) data);
                    }else {
